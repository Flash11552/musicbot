...
# Find the full block of _safe_edit
match = re.search(r'async def _safe_edit\(.*?pass', text, re.DOTALL)
if match:
    old_code = match.group(0)
    new_code = """async def _safe_edit(text: str, markup, chat_id=None, message_id=None, inline_message_id=None):
